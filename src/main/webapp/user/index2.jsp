<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
   <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      <head>
         ...
         <!-- bootstrap css -->
         <link rel="stylesheet" type="text/css" href="http://localhost:8080/baocao/user/css/bootstrap.min.css">
         <!-- style css -->
         <link rel="stylesheet" type="text/css" href="http://localhost:8080/baocao/user/css/style.css">
         <!-- Responsive-->
         ...
         <link
            ...
            rel="stylesheet">
         <!-- owl stylesheets -->
         <link rel="stylesheet" href="http://localhost:8080/baocao/user/css/owl.carousel.min.css">
         <link rel="stylesheet" href="http://localhost:8080/baocao/user/css/owl.theme.default.min.css">
                     ...
                     <div class="col-md-6">
                        <div class="about_taital_main">
                           ...
                           <p class="about_text">labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                              ...
                              ex ea commodo consequatlabore et dolore magna aliqua. Ut enim ad minim veniam, quis
                              nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat</p>
                           <div class="readmore_bt"><a href="#">Read More</a></div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div><img src="http://localhost:8080/baocao/user/images/about-img.png" class="image_3"></div>
                     </div>
                  </div>
               </div>
            </div>
